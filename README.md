...
### 2. Quick Run (Chạy nhanh qua clone, không cần cài đặt cố định)

Nếu bạn chỉ muốn clone dự án để chạy thử và xuất báo cáo ngay lập tức mà không cần cài đặt rườm rà (thư mục có thể xóa ngay sau khi xem kết quả):
...
# 2. Biên dịch nhanh bằng g++ (hoặc MinGW)
g++ *.cpp -O3 -std=c++17 -o LiengSimulation_FastRun

# 3. Chạy phần mềm
./LiengSimulation_FastRun

# Báo cáo dạng HTML sẽ được tự động xuất ra file kết quả để bạn có thể xem trực quan trên trình duyệt.
```
